...
interface contract-tests {
    ...
    test-bounds-called: func() -> bool {
        ...
        /// Should produce diagnostic and compile error 25:
        ///                ^ big does not satisfy the constraint "big (10) > small (20)"
    }

    /// Example 4: Another implicit parameter constraint.
    @test
    test-bounds-called-again: func(small: s32) -> bool {
        let big = 10;
        test-bounds(small, big);
        /// Should produce diagnostic and compile error on line 32:
        ///                        ^ small is implicity constrained by test-bounds(small: s32, big: s32 where big > small) and requires a where constraint satisfying "big > small"
    }
}
