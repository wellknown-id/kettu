...
- **Krust-Sitter Integration**: Utilizes `krust-sitter` for a powerful, grammar-first parsing approach that integrates seamlessly with Rust's type system.
...
- `grammar/`: Krust-Sitter grammar definitions.
